...
file(GLOB objects_detection_SrcCpp
#  ${pdt_module_root}/src/objects_detection/objects_detection.cpp"
...
file(GLOB objects_detection_HelpersCpp
...
file(GLOB objects_detection_SrcGpuCpp
...
file(GLOB objects_detection_SrcCuda
...
list(REMOVE_ITEM objects_detection_SrcCpp ${objects_detection_SrcCuda}) # just in case


if(USE_GPU)

  # add GPU related source code to the executable list
  list(APPEND objects_detection_SrcCpp ${objects_detection_SrcGpuCpp})
  ...
  cuda_add_library(objects_detection_cuda_stuff_library ${objects_detection_SrcCuda})
  target_link_libraries(objects_detection_cuda_stuff_library
     ${CUDA_LIBRARIES}
     ${cutil_LIB}
  )
...
add_library(objects_detection_cpp_stuff_library  ${objects_detection_SrcCpp} ${objects_detection_HelpersCpp})

#add_executable(objects_detection ./objects_detection.cpp)
file(GLOB objects_detection_SrcMain 
	"${pdt_module_root}/src/objects_detection/objects_detection.cpp"
)

set(objects_detection_LinkLibs
#target_link_libraries(objects_detection

   objects_detection_cpp_stuff_library
...
if(USE_GPU)
	#target_link_libraries(objects_detection objects_detection_cuda_stuff_library ${local_CUDA_LIB})
	set(objects_detection_LinkLibs 
		${objects_detection_LinkLibs}
		objects_detection_cuda_stuff_library 
		${local_CUDA_LIB}
	)
endif(USE_GPU)
# ----------------------------------------------------------------------
