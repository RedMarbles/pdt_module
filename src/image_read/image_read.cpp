//This is just a sample program to set up a GUI and print out the images from the camera topics
...
{
	//ROS setup
	ros::init(argc, argv, "image_read_node");
	ros::NodeHandle _nh("~");
