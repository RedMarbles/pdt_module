...
file(GLOB stixel_world_SrcCpp
#  "./*.cpp"
  "${pdt_module_root}/src/stixel_world/stixel_world.cpp"

  "${doppia_src}/applications/stixel_world/StixelWorld*.cpp"
  "${doppia_src}/*.cpp"
...
file(GLOB stixel_world_HelpersCpp
...
set(stixel_world_SrcCpp
	${stixel_world_SrcCpp}
	${stixel_world_HelpersCpp}
)

set(stixel_world_LinkLibs
