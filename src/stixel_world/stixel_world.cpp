//This implements a ROS-compatible version of the stixel_world doppia application
...
#include "libs/pdt_360deg_git/src/applications/stixel_world/StixelWorldApplication.hpp"
...
{
    ros::init(argc, argv, "stixel_world_basic_node");
    ros::NodeHandle _nh("~");
    ...
    try
    {
        ...
        application_p( new doppia::StixelWorldApplication() );
